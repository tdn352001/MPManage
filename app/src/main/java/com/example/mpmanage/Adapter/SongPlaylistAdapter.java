...
public class SongPlaylistAdapter  extends RecyclerView.Adapter<SongPlaylistAdapter.ViewHolder> implements Filterable {
    UpdatePlaylistActivity context;
    ArrayList<BaiHat> arrayList;
    ArrayList<BaiHat> mArrayList;
    boolean isDialog;

    public SongPlaylistAdapter(UpdatePlaylistActivity context, ArrayList<BaiHat> arrayList) {
    ...
    @NonNull
    @Override
    public SongPlaylistAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
